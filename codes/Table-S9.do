...
*****************************************************************************
* 		              PART B. Regresssion: Table-S9	 					*
*****************************************************************************
* whether "no cutlery" before
gen cncb = (ave_p>0)
gen cncb_t = t*cncb


reghdfe p_e_ t if cncb == 1,  absorb(id time_order) vce(cl id city_month)
sum p_e_ if cncb==1 & t == 0

reghdfe p_e_ t if cncb == 0,  absorb(id time_order) vce(cl id city_month)
sum p_e_ if cncb==0 & t == 0

reghdfe p_e_ t cncb_t,  absorb(id time_order) vce(cl id city_month)
