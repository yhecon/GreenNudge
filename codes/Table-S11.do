...
*****************************************************************************
* 		              PART B. Full Results: Table-S11					*
*****************************************************************************

* collected points
replace ave_gp_collect=0 if ave_gp_collect==. /* missing = zero collection */

foreach u of var ave_gp_collect{
	gen v`u' = t*`u'
}
*

reghdfe p_e_ t vave_gp_collect if ave_order !=., absorb(id time_order) vce(cl id city_month)
outreg2 using "$results\test2.xls", dec(3) replace bracket nor2 noobs label addstat(Obs., e(N), AdjustWithinR, e(r2_a_within), Within-R, e(r2_within), Adjusted R-Square, e(r2_a), Consumers, e(N_clust))

reghdfe p_e_ t vave_gp_collect vg_dummy vmobile_1 vmobile_2 vmobile_3 vage_3 vage_4 vage_5 vage_6 vage_7 vage_1 vave_order2-vave_order7 cncb_t  if ave_order !=., absorb(id time_order) vce(cl id city_month)
...
gen vcum_gp_collect = t*cum_gp_collect/1000

reghdfe p_e_ t vcum_gp_collect if ave_order !=., absorb(id time_order) vce(cl id city_month)
outreg2 using "$results\test2.xls", dec(3) replace bracket nor2 noobs label addstat(Obs., e(N), AdjustWithinR, e(r2_a_within), Within-R, e(r2_within), Adjusted R-Square, e(r2_a), Consumers, e(N_clust))

reghdfe p_e_ t vcum_gp_collect vg_dummy vmobile_1 vmobile_2 vmobile_3 vage_3 vage_4 vage_5 vage_6 vage_7 vage_1 vave_order2-vave_order7 cncb_t  if ave_order !=., absorb(id time_order) vce(cl id city_month)
outreg2 using "$results\test2.xls", dec(3) append bracket nor2 noobs label addstat(Obs., e(N), AdjustWithinR, e(r2_a_within), Within-R, e(r2_within), Adjusted R-Square, e(r2_a), Consumers, e(N_clust))


reghdfe p_e_ t vg_dummy vmobile_1 vmobile_2 vmobile_3 vage_3 vage_4 vage_5 vage_6 vage_7 vage_1 vave_order2-vave_order7 cncb_t ptb_t vgp_p2-vgp_p9 if ave_order !=., absorb(id time_order) vce(cl id city_month)
...
reghdfe p_e_ t vg_dummy vmobile_1 vmobile_2 vmobile_3 vage_3 vage_4 vage_5 vage_6 vage_7 vage_1 cncb_t ptb_t vave_order vave_money vave_gp_collect if ave_order !=., absorb(id time_order) vce(cl id city_month)
outreg2 using "$results\hete.xls", dec(3) append bracket nor2 noobs label addstat(Obs., e(N), AdjustWithinR, e(r2_a_within), Within-R, e(r2_within), Adjusted R-Square, e(r2_a), Consumers, e(N_clust))
